    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
      <div className="mb-2 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <span className="rounded bg-crimson/10 px-2 py-0.5 text-xs font-medium text-crimson">
        ...
        {post.status === "draft" && (
          <>
            <button
              onClick={onApprove}
              disabled={busy}
              className="rounded bg-crimson px-3 py-1 text-sm font-medium text-white disabled:opacity-50"
            >
              Aprobar
            </button>
            <button
